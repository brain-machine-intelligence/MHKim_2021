...
def parse_args():
    ...
    parser.add_argument('--hidden-size', default=512, type=int, help="The hidden size of the encoder.") # TODO 221130 512
...
if __name__ == '__main__':
    ...
    encoder = ConvEncoderBENDR(len(To1020.EEG_20_div) + 1, encoder_h=args.hidden_size) # TODO 221130 case0 time domain
