...
def load_data_labels(location='dataset_original.mat'): #2.mat'):
    ...
    dir_label_RPE = "/home/kmh/EEG_preprocessed_mh/pilot_re_label_rpe"
...
class networks():
    def __init__(self, ep):
        ...
        # 0.00003 was good
        ####### 아래 애
        self.c_lr = 3e-7 #5e-6 #1e-6 #5e-7 # 5e-6 #3e-7 # 5e-6 #0.00003 # 3e-7  # 1e-8 # SPE : 3e-7
...
for subi in tqdm(range(2)):
    ...
    for sess_i in range(6):
        if subi == 1 and sess_i == 5 :
            continue
        dir_epoch_ = "/home/kmh/EEG_data_pilot/bcr_fil/" # /home/kmh/EEG_preprocessed_mh
