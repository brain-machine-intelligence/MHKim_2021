...
class networks():
    def __init__(self, ep):
        ...
        # 0.00003 was good
        ####### 아래 애
        self.c_lr = 1e-6 #5e-7 # 5e-6 #3e-7 # 5e-6 #0.00003 # 3e-7  # 1e-8 # SPE : 3e-7
...
for subi in tqdm(range(33)): # TODO : subject number
    # print(subi)
    ...
    for sess_i in range(list_sess_num[subi_for_sess-1]):
        ...
        # else:
        #     subin = subi_matched
        loc_spe = "/home/kmh/prc28_spe_per_subj/subj_{:03d}/sess{}_spe_label.mat".format(subi_matched, sess_i+1)
        loc_rpe = "/home/kmh/prc28_rpe_per_subj/subj_{:03d}/sess{}_rpe_label.mat".format(subi_matched, sess_i+1)
        if len(spe_labels) == 0:
...
for lbi in [5]: # TODO : label 4: spe, 5: rpe
